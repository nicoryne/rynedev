  ...
  return (
    <section id="about" className="relative flex min-h-screen w-full items-center py-16 sm:py-24">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-20 -right-32 h-64 w-64 rounded-full bg-gradient-to-bl from-honey/8 to-transparent" />
        <div className="absolute bottom-32 -left-24 h-48 w-48 rounded-full bg-gradient-to-tr from-thunder/8 to-transparent" />
        <div className="absolute top-1/2 left-1/4 h-32 w-32 rounded-full bg-gradient-to-br from-honey/5 to-transparent" />
      </div>
      ...
      <div className="mx-auto mt-8 sm:mt-16 lg:mt-24 flex flex-col items-center justify-evenly gap-8 sm:gap-12 lg:gap-16 px-4 sm:px-6 lg:px-8 max-w-7xl">
        <MotionComponent
          type="header"
          className="flex w-full flex-col gap-3 sm:gap-4 text-center"
        ...
        <div className="flex w-full flex-col gap-6 sm:gap-8 lg:gap-12 lg:flex-row lg:items-start">
          {/* Image Container */}
          <MotionComponent
            type="div"
          ...
          >
            <Image
              ...
              width={1728}
              height={2048}
              className="h-auto w-64 sm:w-80 lg:w-96 rounded-lg shadow-xl"
              priority
            />
          </MotionComponent>
          ...
          <MotionComponent
            type="div"
            className="flex w-full flex-col gap-4 sm:gap-6 lg:gap-8 rounded-lg bg-white p-4 sm:p-6 lg:p-8 shadow-sm"
            initial={{ opacity: 0, x: 50 }}
            whileInView={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.8, ease: 'easeOut', delay: 0.2 }}
            viewport={{ once: true }}
          >
            <p className="text-sm sm:text-base lg:text-lg xl:text-xl leading-relaxed text-left lg:text-justify">
            ...
            <address className="flex items-center gap-3 sm:gap-4 not-italic mt-2 sm:mt-4">
              <Image
                src="/svg/location-pin.svg"
                alt="Location icon"
                className="h-auto w-6 sm:w-8 flex-shrink-0"
                width={64}
                height={64}
              />
              <span 
                aria-label="Location: Cebu City, Philippines"
                className="text-sm sm:text-base lg:text-lg text-neutral-700"
              >
